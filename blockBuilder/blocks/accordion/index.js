...
class LarsloAccordionBlockRenderEditor extends Component {
	render() {
...
// Register the block
registerBlockType( 'larslo/accordion', {
	title: __( 'larslo Accordion', 'atomic-blocks' ),
	...
	edit: LarsloAccordionBlockRenderEditor,
