 ...
 * 
 * 
 * all frontend block specifics things are done in theme,
 * 
 * 
 ...
 public function __construct () {
   ...
   */
    ...
    // );
      ...
      /* builded blocks for liaison , main file */
      ...
      wp_enqueue_style('editor1',
       ...
       wp_enqueue_style('custom_overwrites',
        plugins_url( 'css/custom_unbuilded_overwrites.css', __FILE__ )
      );
    ...
    // add_filter( 'allowed_block_types', array($this,'allowed_block_types'),8888888888, 2 );
...
function add_block_categories( $categories ) {
   ...
   function block_editor_general_settings() {
...
function allowed_block_types( $allowed_blocks, $posttype ) {
