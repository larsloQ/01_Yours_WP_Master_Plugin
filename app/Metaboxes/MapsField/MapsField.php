...
namespace Yours\Plugin\Metaboxes\MapsField;
...
class MapsField {
	...
	public function setup_admin_scripts($api_key) {
		...
		wp_enqueue_script( 'conditional_hide', plugins_url( 'js/conditional_hide.js', __FILE__ ), array( 'pw-google-maps-api', 'jquery' ), self::VERSION );
