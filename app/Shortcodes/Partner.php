...
class Partner extends Plugin
{
  ...
  public function shortcode() {
    ...
    $all = $this->do_output($orderedposts);
    $out .= $all['out'];
    $cons .= $all['cons'];
   ...
   return $out . "<div class='sep'></div>". $cons;
  }


  function do_output ($orderedposts) {
    $out = "";
    $cons = "";
    foreach ($orderedposts as $key => $value) {
          $out .=  '<div class="small-12 cell accordion-item '.$value[0]['color_name'].'" data-accordion-item>';
                ...
                $out .=  '<div class="accordion-content '.$value[0]['color_name'].'" data-tab-content>';
                  ...
                  $out .=  '</div>';
                  foreach ($value as $p) {
                    /* is_cons trigger an other accordion*/
                    ...
                    $out .=  '<div class="'.$is_cons_class.'">';
                      ...
                      $out .=  "<div class='name'>";
                        $out .=  "<h4>";
                          $out .=  "<a href='".get_the_permalink($p['post']->ID)."'>";
                          $out .=  $p['post']->post_title;
                          $out .=  "</a>";
                        $out .=  "<h4>";
                      $out .=  "</div>";
